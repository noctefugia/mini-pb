...
*   **Двойная зарядка:** Устройство можно заряжать как от Micro-USB, так и от опциональной солнечной панели.
...
5.  **Подключите солечную панель и аккумулятор**, можно приклеить их на двусторонний скотч.
6.  **Соберите корпус**, закрепив плату и крышку винтами М2.

## 📋 Список компонентов (Bill of Materials)
...
## License
This project is licensed under the [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) license. You are free to share and adapt for non-commercial purposes, provided you give appropriate credit.
